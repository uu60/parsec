...
void testMaxFunction(int tid) {
    ...
    if (Comm::isServer()) {
        ...
        Log::i("max_value: {}", StringUtils::vecString(test_view._dataCols[test_view.colIndex("MAX_VALUE")]));
        Log::i("id: {}", StringUtils::vecString(test_view._dataCols[test_view.colIndex("ID")]));
